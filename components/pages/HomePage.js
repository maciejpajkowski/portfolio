    ...
    return (
        <MainContainer>
            <TopContainer>
                <h1>Hello there!</h1>
                <p>
                    Welcome to my personal portfolio website! Here you can find all basic information about my projects.
                    <br />
                    Currently, all their data is being downloaded directly from their respective GitHub repositories
                    using GraphQL.
                </p>
